 ...
 */
final class Version20221031200957 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE action_requested ADD hosted_file_ids LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\'');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE action_requested_hosted_file (action_requested_id INT NOT NULL, hosted_file_id INT NOT NULL, INDEX IDX_196AE73AEE73CD22 (hosted_file_id), INDEX IDX_196AE73A444F097 (action_requested_id), PRIMARY KEY(action_requested_id, hosted_file_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE action_requested DROP hosted_file_ids');
    }
}
